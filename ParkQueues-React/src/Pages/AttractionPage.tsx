import { type Attraction, type HistoryData } from '../Data/Attraction'
...
const AttractionPage = ({ route }: any): React.JSX.Element => {
  ...
  const historicStandby: Array<{
    high: number | undefined
    date: number
  }> = []

  const historicSingleRider: Array<{
    high: number | undefined
    date: number
  }> = []

  const historicBoardingGroup: Array<{
    start: number | undefined
    end: number | undefined
    date: number
  }> = []

  function getStandby (val: HistoryData): number {
  ...
  function getSingleRider (val: HistoryData): number {
